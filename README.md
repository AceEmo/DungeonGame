...
1. **Player Progression:** Health, upgrades, and resources persist only within a run. Permanent unlocks (like new starting items) can be added later.  
2. **Mini-Games:**  
...
3. **Enemy AI:** Simple to advanced enemy behaviors; some track, some shoot, some chase.  
4. **Procedural Rooms:** Rooms generate dynamically, with different enemy layouts, obstacles, and loot drops.  
...
- **Scripting:** C#  
- **Animation & Tweening:** [DOTween](http://dotween.demigiant.com/) for smooth UI and card animations  
...
1. Enter level → explore → fight enemies  
2. Encounter mini-game (Blackjack/Roulette) → risk or reward  
3. Collect loot and upgrades → prepare for next level  
4. Survive until boss / complete run → unlock progression  
...
- **Tweening:** [DOTween by Demigiant](http://dotween.demigiant.com/)  
